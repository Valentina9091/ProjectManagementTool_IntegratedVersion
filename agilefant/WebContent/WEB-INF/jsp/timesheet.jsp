		...
		<tr>
			<td><ww:form action="generateTree" method="post">
				...
				<div id="subItemHeader">
				                       <!-- Added by Sujit -->
									   <!-- Variance and Finance Table-->
										<table>
											<tbody>
												<tr>
													<td><a href="varianceReportView.action">Variance
															Report</a></td>
												</tr>
												<tr>
													<td><a href="financeReportView.action">Finance
															Report</a></td>
												</tr>
												<!--  Added by pengyu -->
												<tr>
													<td><a href="advanceReportView.action">Advance Report
													</a></td>
												</tr>
											</tbody>
										</table>
